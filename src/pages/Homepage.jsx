...
const tpsData = [
  {
    ...
    hours: '24 Jam',
    photo: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQAzOeyzNYemMfg0PXjeWHUolLrXWEUNE2tnw&s',
  },
  {
    name: 'TPA Sarimukti',
    lat: -6.800,
    ...
    hours: '03:00 - 18:00',
    photo: 'https://cdn1-production-images-kly.akamaized.net/d8AzopkxBBJlzk1I-UTM0f1o15o=/1200x675/smart/filters:quality(75):strip_icc():format(jpeg)/kly-media-production/medias/4800469/original/093698900_1712959298-115a9d7a-1a82-4d7d-b82c-3ef7e36252fd.jpg',
  },
  {
    name: 'TPA Jatibarang',
    lat: -7.023,
    ...
    hours: '04:00 - 17:30',
    photo: 'https://mmc.tirto.id/image/2023/03/04/tpa-jatibarang-tirto-2_ratio-16x9.jpg',
  },
  {
    name: 'TPA Suwung',
    lat: -8.722,
    ...
    hours: '07:00 - 15:00',
    photo: 'https://www.setda.denpasarkota.go.id/public/uploads/berita/Berita_232011081111_suasana-tpa-suwung-pasca-berkahirnya-status-darurat-bencana-kebakaran-titik-api-padam-100-persen-status-darurat-bencana-kebakaran-tpa-suwung-berakhir.jpg',
  },
  {
    ...
    hours: '24 Jam',
    photo: 'https://awsimages.detik.net.id/community/media/visual/2023/03/08/kondisi-tpa-antang-makassar_169.jpeg?w=1200',
  },
  {
    ...
    hours: '07:30 - 16:00',
    photo: 'https://www.inibalikpapan.com/wp-content/uploads/2020/08/TPA-Manggar.jpg',
  }, 
  {
    name: 'TPA Batu Layang',
    lat: 0.028,
    lng: 109.322,
    address: 'Jl. Kebangkitan Nasional, Batu Layang, Kec. Pontianak Utara, Kota Pontianak, Kalimantan Barat 78244',
    hours: '08:00 - 17:00',
    photo: 'https://images.genpi.co/resize/320x240-100/uploads/kalbar/arsip/normal/2022/08/11/ruang-terbuka-hijau-yang-ada-di-tpa-batu-layang-kota-pontia-ahyb.webp',
  },
  {
    name: 'TPA Pisugi',
    lat: -3.636,
    ...
    hours: '07:30 - 16:00',
    photo: 'https://www.jayawijayakab.go.id/public/gambarberita/berita/Berita%20Tahun%202025/Berita052.jpg',
  },
  {
    name: 'TPA Karya Jaya',
    lat: -3.051,
...
return () => {
  ...
  const FloatingButton = ({ floatIcon }) => {
    ...
    const handleClick = () => {
      navigate('/Chatbot'); // Navigasi ke halaman Chatbot
    };
            ...
            <div className="swiper-slide position-relative h-100">
              ...
              >
                <div className="text-white">
                  ...
                  <p className="fs-6">
                    Bersama, kita mulai langkah bijak dalam mengelola sampah untuk masa depan yang lebih baik.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="swiper-slide position-relative h-100">
              ...
              >
                <div className="text-white" style={{ maxWidth: 600 }}>
                  <h2 className="fw-bold mb-3" style={{ fontSize: '2.75rem', lineHeight: 1.1 }}>
                    Kenali Sampahmu dengan TrashScan
                  </h2>
                  <p className="fs-5 mb-0">
                    Unggah atau foto sampah, dan kami siap bantu mengklasifikasikan secara otomatis. Saatnya memilah jadi mudah!
                  </p>
                </div>
                <a
                  href="#/scan"
                  className="btn btn-outline-light btn-lg rounded-circle shadow"
                  style={{ width: 56, height: 56, fontSize: '1.5rem', lineHeight: 1 }}
                >
                  →
                </a>
              </div>
...
<section className="row align-items-center mb-5 gx-5">
  <div className="col-md-6 mb-4 mb-md-0">
    <h3 className="fw-bold mb-4" style={{ fontSize: '1.5rem', color: 'black' }}>
      Mengapa Sampah Mendesak Menjadi Masalah yang Mendesak?
    </h3>
    <div className="d-flex justify-content-between text-center fw-semibold" style={{ color: 'black', fontSize: '0.9rem' }}>
      <div style={{ marginRight: '2rem' }}>
        <h4 style={{ fontSize: '2rem', fontWeight: '900' }}>#5</h4>
        <p className="mb-0">Di ASEAN dalam <br />urusan kebersihan</p>
      </div>
      <div style={{ marginRight: '2rem' }}>
        <h4 style={{ fontSize: '2rem', fontWeight: '900' }}>
          33,8<span className="fs-6"> jt</span>
        </h4>
        <p className="mb-0">Ton Sampah <br />pertahunnya</p>
      </div>
      <div>
        <h4 style={{ fontSize: '2rem', fontWeight: '900' }}>11,7%</h4>
        <p className="mb-0">Sampah Yang Berhasil <br />Didaur ulang</p>
      </div>
    </div>
  </div>
...
<section className="mb-5">
  <div className="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="/Article" className="text-primary fw-semibold text-decoration-underline">
      Lihat Semua
    </a>
  </div>
  <div className="row g-4">
    {[
      {
        date: '29 Mei 2025',
        title: 'Dari Satu Ember Sampah, Ema Suranta Bikin Perubahan Lingkungan',
        source: 'SINDOnews',
      ...
      {
        date: '26 Mei 2025',
        title: 'Jatim Berhasil Go Green, Khofifah Buat Program Inovatif Ubah Sampah Rumah Jadi Rupiah',
        source: 'SINDOnews',
      ...
      {
        date: '25 Mei 2025',
        title: 'Sebab Sungai Citeureup, Citarum, dan Bengawan Solo Tercemar',
        source: 'Tempo',
      ...
      <section className="row gx-5 align-items-center mb-5">
        <div className="col-md-6 mb-4 mb-md-0">
          ...
          <p className="text-secondary fs-5" style={{ lineHeight: 1.6 }}>
            Maydarling.id (Mayoritas Sadar Lingkungan) adalah platform digital yang dibangun untuk
            menjawab keresahan akan masalah sampah yang tak kunjung usai. Bukan sekadar edukasi,
            kami hadir untuk menggerakkan perubahan — dari kesadaran menjadi aksi nyata.
          </p>
        </div>
        <div className="col-md-6">
        <a href="/Trashscan" className="text-decoration-none text-dark">
  <div className="d-flex align-items-start mb-4" style={{ cursor: 'pointer' }}>
    <img src={frKamera} alt="Ikon Kamera" className="me-3" style={{ width: 32, height: 32 }} />
    <div>
      <p className="mb-1 fw-semibold">Trashscan: Foto → Kenali Jenis Sampah!</p>
      <p className="text-muted small mb-0">Bingung ini sampah organik atau anorganik? Cukup foto, dan kami bantu jawab!</p>
    </div>
  </div>
</a>

<a href="/Chatbot" className="text-decoration-none text-dark"><div className="d-flex align-items-start">
            <img src={frPesan} alt="Ikon Pesan" className="me-3" style={{ width: 32, height: 32 }} />
            <div>
              <p className="mb-1 fw-semibold">Tanya Lingkungan? ChatBot siap bantu jawab!</p>
              <p className="text-muted small mb-0">
                Cari solusi seputar sampah dan lingkungan? fitur ChatBot kami hadir untuk bantu jawab
                pertanyaanmu.
              </p>
            </div>
          </div>
  ...
  <> 
    ...
    <div style={{
      ...
      <button className="btn btn-dark rounded-circle shadow p-3">
        <img src={floatIcon} alt="Recycle Icon" style={{ width: 24, height: 24 }} />
      </button>
      </a>
    </div>
  </>
