  ...
  return (
    <main className="container py-5">
      ...
      <section className="position-relative mb-5 rounded-3 overflow-hidden" style={{ height: 400 }}>
        ...
        />
        <div className="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center p-4" style={{ backgroundColor: "rgba(0,0,0,0.4)" }}>
          <div className="text-white">
            <span className="badge bg-danger mb-2">SINDOnews</span>
            <h1 className="display-5 fw-bold">Dari Satu Ember Sampah, Ema Suranta Bikin Perubahan Lingkungan</h1>
            <p className="mb-2">29 Mei 2025</p>
            <a href="https://daerah.sindonews.com/read/1573457/174/dari-satu-ember-sampah-ema-suranta-bikin-perubahan-lingkungan-1748473182" target="_blank" rel="noopener noreferrer" className="btn btn-primary">
              Baca Selengkapnya
            </a>
          </div>
        </div>
      ...
      <section className="mb-5">
        <h2 className="fw-bold mb-3">Berita Lingkungan</h2>
        <CardList data={artikelSamping} />
      </section>

      <section className="mb-5">
        <h2 className="fw-bold mb-3">Berita Maydarling</h2>
        <CardList data={beritaMaydarling} />
      </section>

      <section>
        <h2 className="fw-bold mb-3">Edukasi</h2>
